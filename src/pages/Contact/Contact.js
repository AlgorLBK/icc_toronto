    ...
    <div style={{'backgroundColor': '#70358E'}}>
        ...
        <div style={{'display': 'flex', 'flexDirection': 'column', 'justifyContent' : 'center', 'textAlign': 'center'}}>
            <div style={{'display': 'flex', 'justifyContent':'center', 'padding': '15px 5px 5px 5px', 'alignItems':'center'}} >
                <p style={{'textAlign':'center', 'width': '80%', 'color': 'white'}}>Salutations ! Pour nous contacter il vous suffit de remplir ce formulaire et nous vous reviendrons le plus tôt possible.</p>
            </div>
